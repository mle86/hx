...
my %http_info           = map{$_=>1} (100 .. 199);
my %http_success        = map{$_=>1} (200 .. 299);
my %http_redir          = map{$_=>1} (300 .. 399);
my %http_client_error   = map{$_=>1} (400, 404, 405, 407, 408, 410, 411, 413, 414, 415, 419, 429, 430, 431);
my %http_client_failure = map{$_=>1} (401, 402, 403, 406, 409, 412, 416, 417, 418, 420, 421, 422, 423, 424, 425, 426, 427, 428, 451, 432..499);
...
sub is_http_info           ($) { exists $http_info{$_[0]} }
